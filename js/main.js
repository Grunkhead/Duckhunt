    ...
    Crosshair.prototype.onKeyDown = function (event) {
        switch (event.keyCode) {
            case Keynumbers.LEFT:
                console.log('LEFT key pressed derp!')
                new Keys.left(this);
                break;
            case Keynumbers.UP:
                new Keys.up(this);
...
var Duck = (function (_super) {
    ...
    Duck.prototype.reset = function () {
        ...
        var g = Game.getInstance();
        var multiplier = g.level / 4;
        this.sidespeed = Tools.util.randomIntFromInterval(-0.5, 2.5) + multiplier;
...
(function (Keynumbers) {
    ...
    Keynumbers[Keynumbers["SPACE"] = 54] = "SPACE";
...
var Game = (function () {
    ...
    Game.prototype.initializeGame = function () {
        ...
        this.crosshair = new Crosshair(960, 500);
        for (var i = 0; i < 3; i++) {
